...
async function runDemo() {
  ...
  try {
    ...
    console.log('   URL: http://localhost:3838/queue/e476a8e8-0dc2-4455-8e09-3a95f5c1dc8f');
    ...
    const joinResponse = await axios.post(`${BASE_URL}/api/customer/join/e476a8e8-0dc2-4455-8e09-3a95f5c1dc8f`, joinData);
